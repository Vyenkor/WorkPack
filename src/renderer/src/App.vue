...
const currentBreadcrumb = computed(() => {
  if (view.value !== 'project') return ({ home: '工作台', projects: '项目', pending: '待处理', templates: '模板' } as Record<Exclude<MainView, 'project'>, string>)[view.value]
  ...
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <nav class="nav" aria-label="主导航">
        ...
        <button type="button" :class="{ active: view === 'templates' }" @click="go('templates')"><span class="nav-icon">▧</span>模板</button>
      </nav>
