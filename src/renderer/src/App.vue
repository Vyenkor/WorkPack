...
function typeIcon(type: BusinessType): 'shipping' | 'receiving' | 'training' | 'custom' { return type === 'shipping' || type === 'receiving' || type === 'training' ? type : 'custom' }
